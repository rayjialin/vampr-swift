...
class ClosestCommonAncestorTests: XCTestCase {
  ...
  override func setUp() {
    ...
    offspring.0 = Vampire(name: "", yearConverted: 0)
    offspring.1 = Vampire(name: "", yearConverted: 0)
    offspring.2 = Vampire(name: "", yearConverted: 0)
    offspring.3 = Vampire(name: "", yearConverted: 0)
    offspring.4 = Vampire(name: "", yearConverted: 0)
    offspring.5 = Vampire(name: "", yearConverted: 0)
    offspring.6 = Vampire(name: "", yearConverted: 0)
    offspring.7 = Vampire(name: "", yearConverted: 0)
